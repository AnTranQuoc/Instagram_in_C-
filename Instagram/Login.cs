...
namespace Instagram
{
    public partial class Login : Form
    {
        ...
        {
            loginBtn.Image = Image.FromFile("D:\\C#\\Instagram\\png\\4x\\loginBtn_MouseEnter.png");
        }

        private void loginBtn_MouseLeave(object sender, EventArgs e)
        {
            loginBtn.Image = Image.FromFile("D:\\C#\\Instagram\\png\\4x\\loginBtn.png");
        }

        private void registerBtn_MouseEnter(object sender, EventArgs e)
        {
            registerBtn.Image = Image.FromFile("D:\\C#\\Instagram\\png\\4x\\registerBtn_MouseEnter.png");
        }

        private void registerBtn_MouseLeave(object sender, EventArgs e)
        {
            registerBtn.Image = Image.FromFile("D:\\C#\\Instagram\\png\\4x\\registerBtn.png");
        }
        ...
        private void eyeBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                eyeOpen = true;
                eyeBtn.Image = Image.FromFile("D:\\C#\\Instagram\\png\\4x\\eye_open.png");
                edtPwd.PasswordChar = '\0';
            }
            else
            {
                eyeOpen = false;
                eyeBtn.Image = Image.FromFile("D:\\C#\\Instagram\\png\\4x\\eye_close.png");
                edtPwd.PasswordChar = '*';
            }
        }
