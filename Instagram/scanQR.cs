...
namespace Instagram
{
    public partial class scanQR : UserControl
    {
        ...
        {
            openBtn.Image = Image.FromFile("D:\\C#\\Instagram\\png\\4x\\openCamBtn_MouseEnter.png");
        }

        private void openCamBtn_MouseLeave(object sender, EventArgs e)
        {
            openBtn.Image = Image.FromFile("D:\\C#\\Instagram\\png\\4x\\openCamBtn.png");
        }

        private void closeCamBtn_MouseEnter(Object sender, EventArgs e)
        {

            closeBtn.Image = Image.FromFile("D:\\C#\\Instagram\\png\\4x\\closeCamBtn_MouseEnter.png");
        }

        private void closeCamBtn_MouseLeave(Object sender, EventArgs e)
        {

            closeBtn.Image = Image.FromFile("D:\\C#\\Instagram\\png\\4x\\closeCamBtn.png");
        }
        ...
        {
            openProfileBtn.Image = Image.FromFile("D:\\C#\\Instagram\\png\\4x\\openProfileBtn_MouseEnter.png");
        }

        private void openProfileBtn_MouseLeave(object sender, EventArgs e)
        {
            openProfileBtn.Image = Image.FromFile("D:\\C#\\Instagram\\png\\4x\\openProfileBtn.png");
        }
