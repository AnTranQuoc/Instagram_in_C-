...
namespace Instagram
{
    public partial class MainPage : Form
    {
        ...
        {
            homeIcon.Image = Image.FromFile("D:\\C#\\Instagram\\png\\4x\\Home.png");
            isOnHome = false;
            homeFragment.Visible = false;
            findIcon.Image = Image.FromFile("D:\\C#\\Instagram\\png\\4x\\find.png");
            isOnFind = false;
            profileIcon.BackColor = Color.Black;
            isOnProfile = false;
            notiIcon.Image = Image.FromFile("D:\\C#\\Instagram\\png\\4x\\favorite.png");
        ...
        public void ShowHome()
        {
            if (!isOnHome)
            {
                ...
                homeIcon.Image = Image.FromFile("D:\\C#\\Instagram\\png\\4x\\Home_full.png");
                // Đăng ký sự kiện từ changeDefault
                //notification.CloseButtonClicked += CloseEdit_CloseButtonClicked;
            }
        }
        ...
        public void ShowNotification()
        {
            if (!isOnNotification)
            {
                ...
                notiIcon.Image = Image.FromFile("D:\\C#\\Instagram\\png\\4x\\favorite_on.png");
                // Đăng ký sự kiện từ changeDefault
                notification.CloseButtonClicked += CloseEdit_CloseButtonClicked;
            }
        }
        ...
        public void ShowFind()
        {
            if (!isOnNotification)
            {
                ...
                findIcon.Image = Image.FromFile("D:\\C#\\Instagram\\png\\4x\\find_on.png");
                // Đăng ký sự kiện từ changeDefault
                findFragment.CloseButtonClicked += CloseEdit_CloseButtonClicked;
            }
        }
