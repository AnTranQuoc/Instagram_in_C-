...
namespace Instagram
{
    public partial class PostInUser : UserControl
    {
        ...
        public void loadData(string idPost)
        {
            ...
            {
                isLike = true;
                likeBtn.Image = Image.FromFile("D:\\C#\\Instagram\\png\\4x\\favorite_on_red.png");
            }
        ...
        private void likeBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                likeBtn.Image = Image.FromFile("D:\\C#\\Instagram\\png\\4x\\favorite.png");
                isLike = false;
                updateRemoveLike();
            }
        }
        ...
        private void deleteBtn_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.OK)
            {
                ...
                MessageBox.Show("Đã xóa thành công! Hãy thoát bài viết để hệ thống có thể cập nhật", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
