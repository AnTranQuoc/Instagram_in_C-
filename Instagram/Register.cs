...
namespace Instagram
{
    public partial class Register : Form
    {
        ...
        {
            createBtn.Image = Image.FromFile("D:\\C#\\Instagram\\png\\4x\\createBtn_MouseEnter.png");
        }

        private void createBtn_MouseLeave(object sender, EventArgs e)
        {
            createBtn.Image = Image.FromFile("D:\\C#\\Instagram\\png\\4x\\createBtn.png");
        }
        ...
        private void signupBtn_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand sqlCmd = new SqlCommand();
            sqlCmd.CommandType = CommandType.Text;
            sqlCmd.CommandText = "INSERT INTO ACCOUNT VALUES(@USERNAME,@FULLNAME,@BIRTH,@SEX,@PHONE,@EMAIL,@PASSWORD,'D:\\C#\\Instagram\\png\\avatar\\default.png',0,0,0,'')";
